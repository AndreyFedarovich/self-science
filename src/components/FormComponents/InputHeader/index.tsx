import React, {
  ChangeEvent, InputHTMLAttributes, ForwardedRef, forwardRef, LegacyRef
} from 'react';
...
const InputHeader = ({ name, quizSetId, ...props }: InputHeaderProps, ref: InputHeaderRef) => {
